          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                this.$emit('input', false); // inputイベントを発行して自動的にフォームが閉じるようにしている
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    $route: {
      // $routeの監視ハンドラ内でfetchPhotosを実行する。ページが切り替わったときにfetchPhotosが実行されるようにする
      handler: function () {
...
var routes = [{
  path: '/',
  component: _pages_PhotoList_vue__WEBPACK_IMPORTED_MODULE_2__["default"] // props: route => {
...
__webpack_require__(/*! /Users/starboard/laravel_valet/vuesplash3/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/starboard/laravel_valet/vuesplash3/resources/sass/app.scss */"./resources/sass/app.scss");
